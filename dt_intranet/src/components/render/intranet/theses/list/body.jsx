                ...
                <div className="table_design">
                    <div className="superior_content">
                        ...
                        <div class="input-field inp_short">
                            <Link to="/nuevo" className="waves-effect waves-light btn button_new">Agregar Tesis</Link>
                        </div>
                    </div>
                                ...
                                <div className="group_data">
                                    ...
                                    <div>
                                        <div className="two_collections">
                                            ...
                                            <div className="collection with-header">
                                                <li class="collection-header"><span className="subtitle_detail">Editar</span></li>
                                                <div className="collection-item content_icon">
                                                    <a href={"/tesis/" + element.id} className="icon_edit"><IconEdit/></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
